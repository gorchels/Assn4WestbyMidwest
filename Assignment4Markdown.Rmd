...
```
Lobster Carapace length (mm) differed significantly among the five (LTER) sites in the Santa Barbara Channel (F(`r {round(summary(lob_2017_aov)$parameter,3)}`) = )
